...
class AppColors {
  ...
  static const Color emergencyRed = error;
  static const Color safeGreen = success;
  static const Color warningAmber = warning;
  static const Color navBlue = brandPrimary;
  static const Color background = lightBackground;
  static const Color darkText = lightTextPrimary;
  static const Color lightText = lightTextSecondary;
  static const Color backgroundContainer = Colors.white;
  static const Color containerSurfaceHighest = Color(0xFFE5E8EB);
  static const Color backgroundDarkMode = darkBackground;
  static const Color backgroundContainerDark = darkSurface;
  static const Color containerSurfaceHighestDark = Color(0xFF2C2F33);
  static const Color darkThemeText = darkTextPrimary;
  static const Color darkThemeTextSecondary = darkTextSecondary;
}

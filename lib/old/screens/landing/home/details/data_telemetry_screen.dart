...
import 'package:synquerra/old/screens/landing/home/details/detail_screen.dart';
import 'package:synquerra/old/core/models/analytics_model.dart';
import 'package:synquerra/old/screens/landing/home/details/distence_history.dart';
import 'package:synquerra/old/theme/colors.dart';
import 'package:synquerra/old/widgets/custom_snackbar.dart';
...
class _TelemetryDashboardScreenState extends State<DataTelemetryScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _buildCustomAppBar(latestData),
  ...
  // ==================== NEW CUSTOM APP BAR ====================
  PreferredSizeWidget _buildCustomAppBar(AnalyticsData? latestData) {
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  ...
                                  blurRadius:
                                      8 * (1 + _pulseAnimation.value * 0.5),
                                  spreadRadius:
                                      2 * (1 + _pulseAnimation.value * 0.5),
                                ),
                              ],
                            ),
                          );
  ...
  PreferredSizeWidget _buildEmptyStateAppBar() {
    return PreferredSize(
